...
LAYOUTS = {
    "dashboard_vacuum": [
        ...
        (55, 50, 1390, 80, "Scenario 1: Vacuum baseline (0 mW) | Pump power: 0.0 mW | Intrinsic squeezing: ≈ 0 dB | Var(x)=Var(p)=0.5 (vac=0.5)\nVacuum reference scenario with pump power at 0 mW.", "footnote"),
    ],
    "dashboard_calibration": [
        ...
        (180, 173, 253, 253, "Wigner", "box"),
        (640, 173, 680, 253, "Photon Number", "box"),
        (55, 50, 1390, 80, "Scenario 2: Squeezed state (200 mW) | Pump: 200 mW | Intrinsic squeezing: 8.45 dB | Photon cutoff: n=14 | P(n) normalized.\nSqueezed-state calibration scenario using an intrinsic operating point and photon-number diagnostics.", "footnote"),
    ],
    "dashboard_decoherence": [
        ...
        (55, 50, 1390, 80, "Scenario 3: Decoherence + loss | Pump power: 200.0 mW | Squeezing: r=0.97 | Transmissivity: 0.89 | Pre-loss: 8.45 dB | Post-loss: 5.09 dB\nLoss moves squeezing toward vacuum limit (Var = 0.5). Intrinsic magnitude is always >= observed after loss.", "footnote"),
    ],
    "sweep_latency": [
        (35, 30, 1430, 840, "Wrapper", "wrapper"),
        (55, 790, 1390, 40, "Title", "title_box"),
        (135, 250, 1230, 500, "Latency Performance", "box"),
        (55, 50, 1390, 80, "Latency Evaluation Scenario | Profiling end-to-end processing delays\nIncludes client request overhead, hardware execution execution limits, and readout digitization delays.", "footnote"),
    ],
    "sweep_quantization": [
        (35, 30, 1430, 840, "Wrapper", "wrapper"),
        (55, 790, 1390, 40, "Title", "title_box"),
        (135, 250, 1230, 500, "Quantization Errors", "box"),
        (55, 50, 1390, 80, "Quantization Sweep Scenario | Evaluating bit-depth resolution impact\nCompares theoretical squeezing bounds against empirical discretization errors from hardware ADCs.", "footnote"),
    ],
    "calibration_demo": [
        (35, 30, 1430, 840, "Main Dashboard Wrapper", "wrapper"),
        (55, 790, 1390, 40, "Title", "title_box"),
        ...
        (55, 20, 1390, 80, "Calibration Demo Scenario | Phase sweeps over operating points\nDemonstrates live feedback loops tracking maximum quadrature squeezing margins.", "footnote"),
    ]
}
        ...
        if btype == "wrapper":
            ...
            if profile == "paper" and is_foot_wrapper:
                rect = patches.Rectangle(
                    ...
                    linewidth=2.5, edgecolor="#718096", facecolor="none",
                    alpha=0.6, linestyle="dashdot", transform=bg_ax.transAxes
                )
            ...
            if (
                ...
                rect = patches.Rectangle(
                    (norm_x, norm_y), norm_w, norm_h,
                    linewidth=1.5, edgecolor="#a0aec0", facecolor="#1a202c",
                    alpha=0.6, linestyle="solid", transform=bg_ax.transAxes
                )
                bg_ax.add_patch(rect)
            bg_ax.text(
                norm_x + norm_w / 2, norm_y + norm_h / 2,
            ...
            if profile == "web":
                ...
                bg_ax.add_patch(rect)
            bg_ax.text(
                norm_x + 15 / CANVAS_W, norm_y + norm_h / 2,
                display_label, ha="left", va="center",
